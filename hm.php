...
<div id="MyNav">
        <ul>
           ...
           <a href="#"><li>COMPLAINTS</li></a>
           <a href="login2.php"><li>LOGIN/REGISTER</li></a>
...
<div class="col-25"><label for="hdate">Date when incident happend</label></div><div class="col-75"><input type="date" id="hdate" size="30" name="hdate"></div><br> <br>
...
<div class="col-25"><label for="file">Upload any proof of incident </label></div><div class="col-75"><input type="file" id="file" size="30" name="file"></div><br><br><br><br>
...
<div id="butn"><input type="submit" name="save" value="Submit">
</div><br> <br>
<hr>
</div></div>

<p id="p" style="font-size : 20px">Dislaimer:
