...
<div id="MyNav">
        ...
        <a href="admin-dashboard.php"> <li>ADMIN HOME</li></a>
            ...
            <a href="police-data.php"> <li>LIST OF POLICE OFFICERS</li></a>
        </ul>
    </div>
...
<td><?php echo $res['agree']; ?></td>
<td><a href="http://localhost/phpmyadmin/sql.php?db=sample&table=register&pos=0"><i class="fa fa-edit" aria-hidden=""true"></i></a></td>

<td><a href='delete.php?id2 = $res[id]' onclick = 'return checkdel()'><i class="fa fa-trash" aria-hidden=""true"></i></a></td>
</tr>
<script>
function checkdel()
{
